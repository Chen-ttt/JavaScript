...
console.log("null >= false ?", null >= false) // true

console.log("null == 0 ?", null == 0) // false
console.log("null == false ?", null == false) // false

// 原因: 关系运算符和相等运算符 不是一个类别; 前者在设计上会尝试将某个运算元转为number
// 但后者的设计就没有这方面的考虑, 因此不会将null转为其他类型再比较

console.log("null == undefined ?", null == undefined) // true // 特殊例子